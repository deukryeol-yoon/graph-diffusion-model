...
real_graphs = []
for graphset in [QM7b(root = './dataset')]:
...
def train(model, dataloader, args, epochs=5000):
    ...
    with open('graph_embeddings_QM7b.pkl', 'wb') as f:
      pickle.dump(graph_embeddings, f)
    files.download('graph_embeddings_QM7b.pkl')
...
def main():
    ...
    with open('model_QM7b.pkl', 'wb') as f:
      pickle.dump(model, f)
    files.download('model_QM7b.pkl')
