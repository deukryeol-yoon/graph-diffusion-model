...
def train(model, dataloader, args, epochs=5000):
    ...
    with open('graph_embeddings_synthetic_ego.pkl', 'wb') as f:
      pickle.dump(graph_embeddings, f)
    files.download('graph_embeddings_synthetic_ego.pkl')
...
def main():
    ...
    with open('graphs_ego_community.pkl', 'wb') as f:
      pickle.dump(graphs,f)
    files.download('graphs_ego_community.pkl')
    with open('model_synthetic_ego.pkl', 'wb') as f:
      pickle.dump(model, f)
    files.download('model_synthetic_ego.pkl')
